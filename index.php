...
<body id="home" onload="onHomePageLoad()">
  ...
  <!--experience  -->
  <section class="experience bg-primary pt">
    <div class="container">
        ...
        <div id="civilLawModal" class="modal">
          ...
          <div class="modal-content">
            <div class="modal-header">
              ...
              <span class="close" onclick="closeModal('civilLawModal')">&times;</span>
            </div>
            ...
            <div class="modal-footer">
              <button type="button" class="btn" class="close" onclick="closeModal('civilLawModal')">
                إغلاق
              </button>
            </div>
          </div>
        ...
        <div id="corporateLawModal" class="modal">
          ...
          <div class="modal-content">
            <div class="modal-header">
              ...
              <span class="close" onclick="closeModal('corporateLawModal')">&times;</span>
            </div>
            <div class="modal-body">
              <ul>
            ...
            <div class="modal-footer">
              <button type="button" class="btn" class="close" onclick="closeModal('corporateLawModal')">
                إغلاق
              </button>
            </div>
          </div>
        ...
        <div id="familyLawModal" class="modal">
          ...
          <div class="modal-content">
            <div class="modal-header">
              ...
              <span class="close" onclick="closeModal('familyLawModal')">&times;</span>
            </div>
            <div class="modal-body">
              <ul>
                <li>
            ...
            <div class="modal-footer">
              <button type="button" class="btn" class="close" onclick="closeModal('familyLawModal')">
                إغلاق
              </button>
            </div>
          </div>
        ...
        <div id="stateLawModal" class="modal">
          ...
          <div class="modal-content">
            <div class="modal-header">
              ...
              <span class="close" onclick="closeModal('stateLawModal')">&times;</span>
            </div>
            <div class="modal-body">
              <ul>
                <li>
            ...
            <div class="modal-footer">
              <button type="button" class="btn" class="close" onclick="closeModal('stateLawModal')">
                إغلاق
              </button>
            </div>
          </div>
        ...
        <div id="workLawModal" class="modal">
          ...
          <div class="modal-content">
            <div class="modal-header">
              ...
              <span class="close" onclick="closeModal('workLawModal')">&times;</span>
            </div>
            <div class="modal-body">
              <strong>
            ...
            <div class="modal-footer">
              <button type="button" class="btn" class="close" onclick="closeModal('workLawModal')">
                إغلاق
              </button>
            </div>
          </div>
        ...
        <div id="criminalLawModal" class="modal">
          ...
          <div class="modal-content">
            <div class="modal-header">
              ...
              <span class="close" onclick="closeModal('criminalLawModal')">&times;</span>
            </div>
            <div class="modal-body">
              <ul>
                <li>
            ...
            <div class="modal-footer">
              <button type="button" class="btn" class="close" onclick="closeModal('criminalLawModal')">
                إغلاق
              </button>
            </div>
          </div>
  ...
  <section class="bg-primary">
    <h2 class="text-center pt">أخر أخبار المؤسسة</h2>
